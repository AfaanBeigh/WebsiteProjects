          ...
          >
            <div className="left-side">
              ...
              <p>
                ...
                <a href="https://scholar.google.com/citations?user=1rU0mxUAAAAJ&hl=en" target="_blank" className="plain-link">
                  Prabhu Babu
                </a>&nbsp;
                and Prof.&nbsp;
                <a href="https://scholar.google.com/citations?user=pl1PcdIAAAAJ&hl=en" target="_blank" className="plain-link">
                  Aakash Arora
                </a>
                . I closely collaborate with Prof.&nbsp;
                <a href="https://en.wikipedia.org/wiki/Peter_Stoica" target="_blank" className="plain-link">
                  Peter Stoica
                </a>&nbsp;
