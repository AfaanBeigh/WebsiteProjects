...
import { 
  FaHotel, FaMapMarkedAlt, FaCar, FaUtensils, FaCamera, FaMountain,
  ...
  const coreServices = [
    {
      ...
      description: "Luxurious hotels, cozy resorts, and traditional houseboats with world-class amenities and stunning views."
    },
    {
      icon: <FaMapMarkedAlt />,
      title: "Guided Tours",
