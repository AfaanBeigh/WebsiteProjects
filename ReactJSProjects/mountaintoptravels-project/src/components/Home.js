...
import { FaHotel, FaMapMarkedAlt, FaCar, FaUtensils, FaCamera, FaMountain } from 'react-icons/fa';
  ...
  const services = [
    {
      icon: <FaHotel />,
      title: "Accommodation",
      description: "Comfortable stays in premium hotels and resorts across Kashmir, Ladakh, and Jammu."
    },
    {
      icon: <FaMapMarkedAlt />,
